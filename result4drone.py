...
def openPage(length,time):
        ...
        root.title("Result for four Drones")
        ...
        result0 = Image.open("figure_4d/0.png")
        result1 = Image.open("figure_4d/1.png")
        result2 = Image.open("figure_4d/2.png")
        result3 = Image.open("figure_4d/3.png")

        result0_resized = result0.resize((500, 300), Image.ANTIALIAS)
        result1_resized = result1.resize((500, 300), Image.ANTIALIAS)
        result2_resized = result2.resize((500, 300), Image.ANTIALIAS)
        result3_resized = result3.resize((500, 300), Image.ANTIALIAS)

        result0=ImageTk.PhotoImage(result0_resized)
        result1 = ImageTk.PhotoImage(result1_resized)
        result2 = ImageTk.PhotoImage(result2_resized)
        result3 = ImageTk.PhotoImage(result3_resized)

        result0_label=tk.Label(root,image=result0).place(x=200,y=160)
        result1_label = tk.Label(root, image=result1).place(x=900, y=160)
